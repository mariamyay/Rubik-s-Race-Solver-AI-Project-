...
# AStarSeaNrchTree(initial_state=puzzle, n=puzzle.size).searchNumOfMisplaced()

# 1.3
# using linear conflict heuristic
# AStarSearchTree(initial_state=puzzle, n=puzzle.size).searchLinearConf()
...
# 2.3
# using linear conflict heuristic
# AStarSearchGraph(initial_state=puzzle, n=puzzle.s3ize).searchLinearConf()
...
# 4
# using linear conflict heuristic
#IDA(initial_state=puzzle, n=puzzle.size).searchLinearConf()
